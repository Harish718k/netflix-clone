        ...
        <div className="mx-auto container px-4 py-8 h-full">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-20 max-w-6xl mx-auto">
                <div className="mb-4 md:mb-0">
                    ...
                    <p className="mt text-lg">{content?.overview}</p>
                </div>
            ...
            {similarContent.length > 0 && (
                <div className="mt-12 max-w-5xl mx-auto relative">
                    ...
                    <div className="flex overflow-x-scroll no-scrollbar gap-4 pb-4 group" ref={sliderRef}>
                        ...
                        <ChevronRight className='absolute top-1/2 -translate-y-1/2 right-2 w-8 h-8 opacity-0 group-hover:opacity-70 transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full' onClick={scrollRight}/>

                        <ChevronLeft className='absolute top-1/2 -translate-y-1/2 left-2 w-8 h-8 opacity-0 group-hover:opacity-70 transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full' onClick={scrollLeft}/>
                    </div>
                </div>
            )}
        </div>
